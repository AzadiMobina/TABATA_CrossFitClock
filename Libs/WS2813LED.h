...
#define SEGMENT_3_PIN  GPIOE,GPIO_PIN_5 
#define SEGMENT_4_PIN  GPIOC,GPIO_PIN_1 
#define SEGMENT_5_PIN  GPIOC,GPIO_PIN_2
#define SEGMENT_6_PIN  GPIOC,GPIO_PIN_3 
#define SEGMENT_7_PIN  GPIOC,GPIO_PIN_5 
#define SEGMENT_8_PIN  GPIOC,GPIO_PIN_6 
#define SEGMENT_9_PIN  GPIOC,GPIO_PIN_7 
